...
public class CommandManager
{
    ...
    public CommandManager(Scanner scanner, CollectionManager collectionManager){
        ...
        addCommand(new RemoveGreaterKeyCommand(collectionManager));
        addCommand(new CountLessSalaryCommand(collectionManager));
        addCommand(new FilterStartWithCommand(collectionManager));
        addCommand(new PrintDSCEndDateCommand(collectionManager));
    }
